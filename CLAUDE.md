...
3. **報告前に URL 存在確認**: `gh api repos/KazuyaMurayama/creativity-research-v1/contents/PATH?ref=BRANCH` でステータス200確認。
...
### ファイル名
- 基本形 `<TOPIC>_YYYYMMDD.md`（**サフィックス・ハイフンなし**）。例: `CREATIVITY_REPORT_20260603.md`
- 同日中の追加更新は `-v2`、`-v3`（例: `CREATIVITY_REPORT_20260603-v2.md`）。
- 日付が変わったら v サフィックスをリセット（例: 翌日1回目 `CREATIVITY_REPORT_20260604.md`）。
...
| トリガー | スキル |
|---|---|
| 創造性・先行研究の調査 | `.claude/skills/research-deep/SKILL.md` |
